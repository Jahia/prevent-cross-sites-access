...
public class CrossSitesFilter extends AbstractServletFilter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        final String requestURI = hsRequest.getRequestURI();
        if (requestURI.contains(URI_PART_SITES)) {
            final String siteKeyFromPath = StringUtils.substringBetween(requestURI, URI_PART_SITES, "/");
